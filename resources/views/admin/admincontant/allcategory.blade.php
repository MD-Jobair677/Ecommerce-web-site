					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="{{route('admin.categorypage')}}" class="btn btn-primary">New Category</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
					...
					<div class="container-fluid">
						<div class="card">
							...
							<form action="" method="get">
								...
								<input type="button" class="btn btn-primary" onclick="window.location.href='{{route('admin.allcategory')}}'"   value="Reset">
							</div>
							...
							<div class="card-body table-responsive p-0">								
								<table class="table table-hover text-nowrap">
									...
									<tbody>
										...
										@forelse ($categoris as  $key=>$category)
										<tr>
											
											
											<td>{{$categoris->firstItem()+$key}}</td>
											<td>{{$category->name}}</td>
											<td>{{$category->slug}}</td>
											<td>
											...
											<td>
												<a href="{{route('admin.updatepage',$category->id)}}">
