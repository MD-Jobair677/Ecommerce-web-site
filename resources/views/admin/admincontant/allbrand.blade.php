        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{route('admin.createbrand')}}" class="btn btn-primary">New Brand</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">								
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @forelse ($allbrands as  $key=>$allbrand)
                            
                            <tr>
                                <td>{{$allbrands->firstItem()+$key}}</td>
                                <td>{{$allbrand->brandname}}</td>
                                <td>{{$allbrand->slug}}</td>
