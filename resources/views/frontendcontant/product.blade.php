        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    ...
                    <li class="breadcrumb-item">{{$singleproducts->title}}</li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <div class="row ">
                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        <h2 class="price text-secondary"><del>${{$singleproducts->compareprice}} </del></h2>
                        <h2 class="price "> ${{$singleproducts->price}}</h2>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                <div id="related-products" class="carousel">
                    ...
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href='#' class="product-img"><img class="card-img-top" src="{{asset('storage/productimage/'.$relatedproduct->image)}}" alt=""></a>
                            <a class="whishlist" href="222"><i class="far fa-heart"></i></a>                            
                        ...
                        <div class="card-body text-center mt-3">
                            ...
                            <div class="price mt-2">
                                ...
                                <span class="h6 text-underline"><del>${{$relatedproduct->compareprice}}</del></span>
                            </div>
                        </div>                        
                    </div> 
